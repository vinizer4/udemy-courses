            ...
            <td>
                {!deletando &&
                    <button
                        ...
                        className='button is-success is-rounded is-medium is-responsive'
                    >
                        Editar
                    </button>
                }
                <button
                    ...
                    className='button is-danger is-rounded is-medium is-responsive'>
                    {deletando ? "Confirmar?" : "Deletar"}
                </button>
                {deletando &&
                    <button
                        onClick={cancelaDelete}
                        className='button is-rounded is-medium is-responsive'>
                        Cancelar
                    </button>
                }
            </td>
